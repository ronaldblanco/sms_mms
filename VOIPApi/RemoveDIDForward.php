...
$epgId = isset($_GET['epgId']) ? $_GET['epgId'] : "";
...
if(
	...
	$param=array('login'=>$user,'secret'=>$pass,'tn'=>$did,'epgId'=>$epgId);
	$response =$soapclient->RemoveDIDForward($param);
	$result = json_encode($response);
	$outResult = json_decode($result,true)["RemoveDIDForwardResult"]["responseMessage"];
