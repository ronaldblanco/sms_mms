...
//Get ENV
	$env = file_get_contents('../../../.env_test', true);
	$env = explode("\n",$env);
	$getEnv = [];
	foreach($env as $data){
		$data = explode("=",$data);
...
$pbxhandler = "https://".$domain."/client_app/messages/ahhsajhkcbdwolcbolwdiuhboiget_sms.php";

/*$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $pbxhandler);
